...
В этом примере a и b являются параметрами метода. Это не локальные переменные. Обращайте внимание на переменную var, используемую с конструкторами, параметрами метода или переменными экземпляра. Использование var в одном из этих 
...
На экзамене будет предпринята попытка обмануть вас различными вопросами, касающимися объема знаний. Вероятно, вы увидите вопрос, который, по-видимому, касается чего-то сложного и не может быть скомпилирован, потому что одна из переменных выходит за рамки области видимости.
...
### Применение области действия к классам или Применение области видимости к классам
