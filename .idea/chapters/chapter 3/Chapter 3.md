...
Вторая форма, которую может принимать цикл while, называется циклом do/while, который, как и цикл while, представляет собой структуру управления повторением с условием завершения и оператором или блоком операторов, как показано на рис. 3.6.

Вторая форма, которую может принимать цикл while, называется циклом do/while, который, как и цикл while, представляет собой структуру управления повторением с условием завершения и инструкцией или блоком инструкций, как показано на рисунке 3.6.
