...
В операциях format() и formatted() параметры вставляются и форматируются с помощью символов в том порядке, в котором они указаны в vararg. В таблице 4.2 перечислены те, которые вы должны знать для сдачи экзамена.
or
В операциях format() и formatted() параметры вставляются и форматируются с помощью символов в том порядке, в котором они указаны в vararg. В Таблице 4.2 перечислены те, которые вы должны знать для экзамена.