...
Правильный ответ - anim 7 s. Вызовы метода indexOf() возвращают 0 и 4 соответственно. Метод substring() возвращает строку, начинающуюся с индекса 0 и заканчивающуюся непосредственно перед индексом 4.
