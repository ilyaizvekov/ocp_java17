...
Это все, что вам нужно знать о переопределении методов для этой главы. В главе 9 «Коллекции и универсальные шаблоны» мы 
еще раз вернемся к переопределяющим методам, использующим универсальные шаблоны. Всегда есть чему поучиться!
